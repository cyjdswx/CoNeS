...
if __name__=='__main__':
    ...
    parser.add_argument('--lambda_seg', type=float, default=10.0, help='weight for L1 loss')
    ...
    start_epoch = 1
    #val_seg_loss, val_rec_loss, generated_img = trainer.run_evalutation_during_training(val_dataloader)
    for epoch in range(1, total_epochs + 1):
        ...
        for i in range(batches_per_epoch):
            ...
            # Training
            g_losses, pred_img, pred_seg = trainer.run_generator_one_step(data_i)
            if use_gan:
        ...
        print('updating learning rate:lr_G:%f, lr_D:%f' % \
                #(trainer.lr_scheduler_G.get_last_lr()[0], trainer.lr_scheduler_S.get_last_lr()[0], trainer.lr_scheduler_D.get_last_lr()[0]))
